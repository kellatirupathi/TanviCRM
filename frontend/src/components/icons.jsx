...
export const Icon = {
  ...
  eyeOff: (p) => (<svg {...base} {...p}><path d="M9.9 4.24A9.1 9.1 0 0 1 12 4c6.5 0 10 7 10 7a18.5 18.5 0 0 1-2.16 3.19m-2.93 2.93A9.1 9.1 0 0 1 12 18c-6.5 0-10-7-10-7a18.5 18.5 0 0 1 5.06-5.94M9.9 9.9a3 3 0 0 0 4.2 4.2M1 1l22 22" /></svg>),
};
